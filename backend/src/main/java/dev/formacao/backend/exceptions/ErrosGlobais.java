...
public class ErrosGlobais extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity formatarBadCredentialsException(BadCredentialsException e) {
        return ResponseEntity.badRequest().body(new ErroResponse("Email ou senha inválidos"));
    }
